...
%spacing doit être en dehors de columns
%\emph{} non accepté dans l'envir de columns
% GROS BUG Beamer!!! pseudocode[disply]{}{} génère des erreurs de compil. (retour à la ligne \\ impossible)