	...
	\begin{columns}[T]
	  \begin{column}{.68\textwidth}
		...
		\begin{column}{.3\textwidth}
		  \begin{center}
		  \href{run:/home/nuno/Documents/Stage/Documents/Videos/14-ichr-metapod-v6-submitted.mp4}{\includegraphics[width=.9\textwidth, page=1]{figs/hrp2Control}} \\
		  \bigskip
			\href{run:/home/nuno/Documents/Stage/Documents/Videos/14-ichr-metapod-v6-submitted.mp4}{\includegraphics[width=.9\textwidth, page=1]{figs/hrp2Control}}
			\hfill
			\end{center}
...
\begin{frame}
  ...
  \begin{block}{Prochains objectis}
  \begin{itemize}
